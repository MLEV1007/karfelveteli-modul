...
interface CustomerSubmissionEmailProps {
  ownerName: string
  vehiclePlate: string
  vehicleMake: string
  vehicleModel: string
...
// Azonnali visszaigazolás a kárfelvételi űrlap beküldésekor — még a jegyzőkönyv
// lezárása előtt, ezért nincs PDF melléklet (lásd CustomerEmail.tsx a véglegeshez).
export default function CustomerSubmissionEmail({
  ownerName,
  vehiclePlate,
  vehicleMake,
  vehicleModel,
    ...
    <Html lang="hu">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Heading style={h1}>Kárfelvétel beérkezett</Heading>

          <Text style={text}>Tisztelt {ownerName}!</Text>
          ...
          <Section style={summaryBox}>
            ...
            <Row>
              ...
              <Column style={valueColumn}>
                <Text style={value}>{vehiclePlate.toUpperCase()}</Text>
              </Column>
            </Row>
            <Row>
              <Column style={labelColumn}>
          ...
          <Text style={text}>
            A gépjármű átvételekor szervizünk technikusa rögzíti a jegyzőkönyvet. A
            végleges kárbejelentő lapot, meghatalmazást és jegyzőkönyvet PDF formátumban
            e-mailben küldjük el a megadott e-mail címre, amint a jegyzőkönyv lezárásra
            kerül.
          </Text>
