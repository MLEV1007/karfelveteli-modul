  ...
  return (
    <Page size="A4" style={s.page}>
      ...
      <Text style={s.paragraph}>
        ...
        <Text style={s.bold}>{WORKSHOP_LEGAL.companyName}</Text>-t (adószám: {WORKSHOP_LEGAL.taxNumber},
        székhely: {WORKSHOP_LEGAL.address}, a továbbiakban: Meghatalmazott), hogy a fent megjelölt gépjárművön
        bekövetkezett káreseménnyel kapcsolatban a {insurerLabel} biztosítónál a kárügyet teljes körűen
        képviselje, a kárrendezéshez szükséges nyilatkozatokat, dokumentumokat a Meghatalmazó nevében aláírja,
        a javítással kapcsolatos számlát a biztosító felé közvetlenül benyújtsa, és a kárrendezés
        eredményeként megítélt összeget — a Meghatalmazó kifejezett hozzájárulásával — közvetlenül a
        Meghatalmazott bankszámlájára (számlaszám: {WORKSHOP_LEGAL.bankAccount}) kérje folyósítani.
      </Text>
      ...
      <View style={s.signatureRow}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={[s.label, { marginBottom: 20 }]}>Kelt: {formatDate(data.createdAt)}, {WORKSHOP_LEGAL.location}</Text>
        </View>
      </View>
