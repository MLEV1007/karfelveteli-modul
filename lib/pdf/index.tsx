...
// 1) Kárbejelentő lap, 2) Meghatalmazás, 3) Iratösszesítő, 4) Jegyzőkönyv / Munkalap.
const PAGE_ORDER = [DamageReportPage, AuthorizationPage, DocumentChecklistPage, WorkOrderPage] as const
